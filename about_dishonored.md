...
These different approaches to player choice are most pronounced in the gameplay, but their effects go much, much deeper than that. They reverberate through the games settings, plot and fantasies and can be felt in every aspect of the two games.

* Because Dishonored 1 is really committed to its overly simplistic GOOD/BAD dichotomy.
To be good you have to sneak and to not kill, but the non-lethal takedowns are extremely cruelly ironic. Lady boyles “crime” is of a sexual nature and so her punishement is as well. As long as you dont kill, the game thinks you are GOOD, even if you really arent. In the same way, Pietro is not punished for peeking on callista, he is only ridiculed for getting caught, for being bad at stealth, because Dishonored 1 unquestioningly believes in its own ludonarrative setup.

* This extends to the city. Dunwall is as full of contrast as you would expect from all the spotlights that have been left lying around, its a city of rich and poor, of bright and dark, of healthy and sick, of GOOD and BAD. 

* Following the stageplay setup, characters are used representationally and are allowed to evolve. Daud starts as a BAD Assasin,as the murderer, but then becomes regretful. You start as a GOOD bodyguard who protects life, but when you meet daud, you yourself might have changed  already.

* The Drama of Good & Bad is built on a dramatic gameplay arc. Your goals are to rescue emily and take to revenge. The first two missions are about emily and both start in the same location, grounding you in dunwall. To not repeat itself too much, Dishonored mixes things up with the vertical bridge level and the social stealth of lady boyle as you get closer to the lord regents relatively easy and conventional level. 
After you are betrayed you just rescue emily and take revenge again, but this time you do it in a single day, climbing from the lowest gutter and the diseased streets to the highest, most reclusive tower of dunwall.

Dishonored 1 runs on a dramatic arc, while Dishonored 2 is compartmentalised. 

* You move between Dunwall and Karnaka quickly while long stretches of in-game time pass. Your hub is literally un-grounded and gameplay elements are no longer represented in characters.

* In a general move away from its ethical problems, Nonlethal Takedowns are now restorative, only the tech-bro stand-in jindosh is punished ironically, as a kind of redemption for what happened to  Lady Boyle.
...
* Dishonored 2 is like the jindosh lock. It has many unique combinations and ways to solve it, but solving it always leads to the same place.
