[back](thinking) <br> published 22/01/19
...
- Do not use hashtags
  ...
  - People do not enjoy reading. Hashtags increase the amount of text in a tweet.
    ...
    > My most widely shared tweet has no hashtag at all in it. <br>
...
- Tell stories through gifs
  ...
  - People like stories. You can tell a story through a gif.<br>
    I use a narrative structure called <a href=" https://en.wikipedia.org/wiki/Kish%C5%8Dtenketsu" target="_blank">Kishōtenketsu</a> to make my gifs. It consists of 4 story beats:
    ...
    > **Step 2: Develop**
    >
    > Introduce a challenge that can be overcome with what you have shown in step one. <br>
    ...
    > **Step 3: Subvert**
    >
    > Your audience expects to see the solution to the problem you introduced.
    > They are not going to get it just yet.<br>
    > This means that the character falls into the pit, gets hit by an enemie or misses the coin.<br>
    > Failure is an important part of most stories and will make it more satisfying when the obstacle is overcome.
    >
    > Here, you show the consequences of not using the abilities of the character efficiently. <br>
    ...
    > Add a short time of stillness, to allow people to exit the world of your game.<br>
...
- Everything, right now, forever
  ...
  - There is a lot of debating to be done about games. There are the newest news to react to, hot takes to be made and controversial gaming opinions to be held.
    ...
    Luckily I have always been to shy and uncertain to participate in these discussions. But I have been following them for years now.<br>
    ...
    I never really questioned how much more useful information and how much more opportunities came to me through actually releasing games.
...
- Only tweet about finished projects
  - I will only tweet to announce the release of a game, text or whatever.<br>
    If you want to talk to me, my DMs are always open.
  - ​
